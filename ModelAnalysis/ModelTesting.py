# -*- coding: utf-8 -*-
"""
Created on Mon Jun 24 08:19:33 2019
...
sk.metrics.accuracy_score(train_labels, predictions_train)
sk.metrics.accuracy_score(test_labels, predictions_test)

sk.metrics.precision_score(train_labels, predictions_train)
sk.metrics.precision_score(test_labels, predictions_test)

sk.metrics.recall_score(train_labels, predictions_train)
sk.metrics.recall_score(test_labels, predictions_test)
